...
/**
 * THU hxd , for Cassandra 2.* and CQL3
...
public class CassandraClient20 extends DB
{
  ...
  public static final String NEED_TRACING= "cassandra.tracing";
  public static final String NEED_TRACING_DEFAULT="false";
  ...
  {
    CassandraClient20 cli = new CassandraClient20();
